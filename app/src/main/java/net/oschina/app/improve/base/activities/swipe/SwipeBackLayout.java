...
public class SwipeBackLayout extends FrameLayout {
    ...
    public SwipeBackLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (edgeSize > 0)
            setEdgeSize(edgeSize);  //设置边缘Edge
        int mode = EDGE_FLAGS[a.getInt(R.styleable.SwipeBackLayout_edge_flag, 0)];//没有设置,取数组的0索引为left
        setEdgeTrackingEnabled(mode);   //设置滑动方向为 left
        ...
        mDragHelper.setMinVelocity(minVel); //设置(Velocity)速率
